...
if ( ! class_exists( 'vw_car_rental_content_creation' ) ) :

	/**
	 * vw_car_rental_content_creation class.
	 */
	class VW_Car_Rental_Content_Creation extends WP_Customize_Control {
		...
		/**
		 * vw_car_rental_content_creation constructor.
		 *
		...
		public function __construct( WP_Customize_Manager $manager, $id, array $args ) {
			$this->button_text;
			$manager->register_control_type( 'vw_car_rental_content_creation' );
