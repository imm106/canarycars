...
add_action( 'customize_register', 'vw_car_rental_typography_customize_register', 15 );

# Load scripts and styles.
add_action( 'customize_controls_enqueue_scripts', 'vw_car_rental_customize_controls_register_scripts' );
add_action( 'customize_preview_init', 'vw_car_rental_customize_preview_enqueue_scripts'   );

# Add custom styles to `<head>`.
add_action( 'wp_head', 'vw_car_rental_print_styles' );

function vw_car_rental_typography_customize_register( $wp_customize ) {
	...
	$wp_customize->register_control_type( 'VW_Car_Rental_Control_Typography' );

	// Add the typography panel.
	$wp_customize->add_panel( 'vw_car_rental_typography', array( 'priority' => 5, 'title' => esc_html__( 'Typography', 'vw-car-rental' ) ) );

	// Add the `<p>` typography section.
	$wp_customize->add_section( 'vw_car_rental_p_typography',
		array( 'panel' => 'vw_car_rental_typography', 'title' => esc_html__( 'Content Typography', 'vw-car-rental' ) )
	);

	// Add the headings typography section.
	$wp_customize->add_section( 'vw_car_rental_headings_typography', 
		array( 'panel' => 'vw_car_rental_typography', 'title' => esc_html__( 'Headings Typography', 'vw-car-rental' ) )
	);

	// Add the Global Color typography section.
	$wp_customize->add_section( 'vw_car_rental_global_typography', 
		array( 'panel' => 'vw_car_rental_typography', 'title' => esc_html__( 'Global Typography', 'vw-car-rental' ) )
	);

  	$wp_customize->add_setting( 'vw_car_rental_first_color', array(
	    'default' => '#bfe428',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_car_rental_first_color', array(
  		'label' => __('First Highlight Color', 'vw-car-rental'),
	    'description' => __('It will change the highlight color in one click.', 'vw-car-rental'),
	    'section' => 'vw_car_rental_global_typography',
	    'settings' => 'vw_car_rental_first_color',
  	)));

  	$wp_customize->add_setting( 'vw_car_rental_second_color', array(
	    'default' => '#15d0ac',
	    'sanitize_callback' => 'sanitize_hex_color'
  	));
  	$wp_customize->add_control( new WP_Customize_Color_Control( $wp_customize, 'vw_car_rental_second_color', array(
  		'label' => __('Second Highlight Color', 'vw-car-rental'),
	    'description' => __('It will change the highlight color in one click.', 'vw-car-rental'),
	    'section' => 'vw_car_rental_global_typography',
	    'settings' => 'vw_car_rental_second_color',
  	)));
...
function vw_car_rental_customize_controls_register_scripts() {
	wp_enqueue_script( 'vw-car-rental-ctypo-customize-controls', trailingslashit( get_template_directory_uri() ) . 'inc/typography/js/customize-controls.js',array( 'customize-controls' )  );

	wp_enqueue_style( 'vw-car-rental-ctypo-customize-controls-style', trailingslashit( get_template_directory_uri() ) . 'css/customize-controls.css' );
}
...
function vw_car_rental_customize_preview_enqueue_scripts() {
	wp_enqueue_script( 'vw-car-rental-ctypo-customize-preview', trailingslashit( get_template_directory_uri() ) . 'inc/typography/js/customize-preview.js',array( 'jquery' )  );
}
...
function vw_car_rental_print_styles() {
	...
	/* === <p> === */
	$p_color = get_theme_mod( 'vw_car_rental_p_font_color' );
	$p_family = get_theme_mod( 'vw_car_rental_p_font_family' );
	$p_weight = get_theme_mod( 'vw_car_rental_p_font_weight' );
	$p_style  = get_theme_mod( 'vw_car_rental_p_font_style' );
	$p_size   = get_theme_mod( 'vw_car_rental_p_font_size' );
	$p_line_h = get_theme_mod( 'vw_car_rental_p_line_height' );
	$p_letter_s = get_theme_mod( 'vw_car_rental_p_letter_spacing' );
	...
	/* === <a> === */
	$a_color = get_theme_mod( 'vw_car_rental_a_font_color' );
	$a_family = get_theme_mod( 'vw_car_rental_a_font_family' );
	$a_weight = get_theme_mod( 'vw_car_rental_a_font_weight' );
	$a_style  = get_theme_mod( 'vw_car_rental_a_font_style' );
	$a_size   = get_theme_mod( 'vw_car_rental_a_font_size' );
	$a_line_h = get_theme_mod( 'vw_car_rental_a_line_height' );
	$a_letter_s = get_theme_mod( 'vw_car_rental_a_letter_spacing' );
	...
	$h1_color = get_theme_mod( 'vw_car_rental_h1_font_color' );
	$h1_family = get_theme_mod( 'vw_car_rental_h1_font_family' );
	$h1_weight = get_theme_mod( 'vw_car_rental_h1_font_weight' );
	$h1_style  = get_theme_mod( 'vw_car_rental_h1_font_style' );
	$h1_size   = get_theme_mod( 'vw_car_rental_h1_font_size' );
	$h1_line_h = get_theme_mod( 'vw_car_rental_h1_line_height' );
	$h1_letter_s = get_theme_mod( 'vw_car_rental_h1_letter_spacing' );
	...
	$h2_color = get_theme_mod( 'vw_car_rental_h2_font_color' );
	$h2_family = get_theme_mod( 'vw_car_rental_h2_font_family' );
	$h2_weight = get_theme_mod( 'vw_car_rental_h2_font_weight' );
	$h2_style  = get_theme_mod( 'vw_car_rental_h2_font_style' );
	$h2_size   = get_theme_mod( 'vw_car_rental_h2_font_size' );
	$h2_line_h = get_theme_mod( 'vw_car_rental_h2_line_height' );
	$h2_letter_s = get_theme_mod( 'vw_car_rental_h2_letter_spacing' );
	...
	$h3_color = get_theme_mod( 'vw_car_rental_h3_font_color' );
	$h3_family = get_theme_mod( 'vw_car_rental_h3_font_family' );
	$h3_weight = get_theme_mod( 'vw_car_rental_h3_font_weight' );
	$h3_style  = get_theme_mod( 'vw_car_rental_h3_font_style' );
	$h3_size   = get_theme_mod( 'vw_car_rental_h3_font_size' );
	$h3_line_h = get_theme_mod( 'vw_car_rental_h3_line_height' );
	$h3_letter_s = get_theme_mod( 'vw_car_rental_h3_letter_spacing' );
	...
	$h4_color = get_theme_mod( 'vw_car_rental_h4_font_color' );
	$h4_family = get_theme_mod( 'vw_car_rental_h4_font_family' );
	$h4_weight = get_theme_mod( 'vw_car_rental_h4_font_weight' );
	$h4_style  = get_theme_mod( 'vw_car_rental_h4_font_style' );
	$h4_size   = get_theme_mod( 'vw_car_rental_h4_font_size' );
	$h4_line_h = get_theme_mod( 'vw_car_rental_h4_line_height' );
	$h4_letter_s = get_theme_mod( 'vw_car_rental_h4_letter_spacing' );
	...
	$h5_color = get_theme_mod( 'vw_car_rental_h5_font_color' );
	$h5_family = get_theme_mod( 'vw_car_rental_h5_font_family' );
	$h5_weight = get_theme_mod( 'vw_car_rental_h5_font_weight' );
	$h5_style  = get_theme_mod( 'vw_car_rental_h5_font_style' );
	$h5_size   = get_theme_mod( 'vw_car_rental_h5_font_size' );
	$h5_line_h = get_theme_mod( 'vw_car_rental_h5_line_height' );
	$h5_letter_s = get_theme_mod( 'vw_car_rental_h5_letter_spacing' );
	...
	$h6_color = get_theme_mod( 'vw_car_rental_h6_font_color' );
	$h6_family = get_theme_mod( 'vw_car_rental_h6_font_family' );
	$h6_weight = get_theme_mod( 'vw_car_rental_h6_font_weight' );
	$h6_style  = get_theme_mod( 'vw_car_rental_h6_font_style' );
	$h6_size   = get_theme_mod( 'vw_car_rental_h6_font_size' );
	$h6_line_h = get_theme_mod( 'vw_car_rental_h6_line_height' );
	$h6_letter_s = get_theme_mod( 'vw_car_rental_h6_letter_spacing' );
	...
	if ( $style ) {
		...
		// Body class filter.
		add_filter( 'body_class', 'vw_car_rental_body_class' );
	}
}
 ...
 * @return array
 */
function vw_car_rental_body_class( $classes ) {
