...
<main id="maincontent" role="main">
  ...
  <?php if( get_theme_mod( 'vw_car_rental_slider_hide_show',true) != '') { ?>
  ...
  <section id="slider">
    <div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel"> 
          ...
          <div <?php if($i == 1){echo 'class="carousel-item active"';} else{ echo 'class="carousel-item"';}?>>
            ...
            <div class="carousel-caption">
              <div class="inner_carousel">
                ...
                <div class="more-btn">
                  <a class="view-more" href="<?php echo esc_url(get_permalink()); ?>"><?php esc_html_e( 'LEARN MORE', 'vw-car-rental' ); ?><i class="<?php echo esc_html(get_theme_mod('vw_car_rental_slider_button_icon','fa fa-angle-right')); ?>"></i>
                  <span class="screen-reader-text"><?php esc_html_e( 'LEARN MORE','vw-car-rental' );?></span></a>
                </div>
              </div>
            </div>
          </div>
      ...
      <a class="carousel-control-prev" href="#carouselExampleIndicators" role="button" data-slide="prev">
        ...
        <span class="screen-reader-text"><?php esc_attr_e( 'Previous','vw-car-rental' );?></span>
      </a>
      <a class="carousel-control-next" href="#carouselExampleIndicators" role="button" data-slide="next">
        <span class="carousel-control-next-icon" aria-hidden="true"><i class="fas fa-chevron-right"></i></span>
        <span class="screen-reader-text"><?php esc_attr_e( 'Next','vw-car-rental' );?></span>
      </a>
    </div>
  ...
  <section id="category-sec">
    <div class="container">
      <div class="row m-0">
        <?php
          $catData =  get_theme_mod('vw_car_rental_category','');
          if($catData){
          $page_query = new WP_Query(array( 'category_name' => esc_html($catData,'vw-car-rental'))); ?>
            ...
            <div class="col-lg-4 col-md-4 category_main p-0">
              <div class="catgory-box">
                ...
                <div class="category-btn">
                  <a class="view-more" href="<?php echo esc_url(get_permalink()); ?>"><?php esc_html_e( 'READ MORE', 'vw-car-rental' ); ?><i class="<?php echo esc_html(get_theme_mod('vw_car_rental_category_btn_icon','fa fa-angle-right')); ?>"></i>
                  <span class="screen-reader-text"><?php esc_html_e( 'READ MORE','vw-car-rental' );?></span></a>
                </div>              
              </div>
              <hr>
            </div>
  ...
  <section id="service-sec">
    <div class="container">
      ...
      <div class="row m-0">
        <?php
          $catData =  get_theme_mod('vw_car_rental_services','');
          if($catData){
          $page_query = new WP_Query(array( 'category_name' => esc_html($catData,'vw-car-rental'))); ?>
          <?php while( $page_query->have_posts() ) : $page_query->the_post(); ?>
            <div class="col-lg-4 col-md-4 service_main">
              <div class="service-box">
                ...
                <a href="<?php echo esc_url(get_permalink()); ?>"><?php esc_html_e( 'LEARN MORE', 'vw-car-rental' ); ?><span class="screen-reader-text"><?php esc_html_e( 'LEARN MORE','vw-car-rental' );?></span></a>
              </div>
            </div>
          <?php endwhile;
          wp_reset_postdata();
