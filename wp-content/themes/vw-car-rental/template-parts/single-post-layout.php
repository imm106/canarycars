    ...
    <div class="single-post">
       ...
       <?php if(has_post_thumbnail()) { ?>
        ...
        <div class="entry-content">
            <?php the_content(); ?>
            <?php if(get_theme_mod('vw_car_rental_toggle_tags',true)==1){ ?>
        ...
        <?php
            ...
            if ( is_singular( 'attachment' ) ) {
                ...
                the_post_navigation( array(
                    'prev_text' => _x( '<span class="meta-nav">Published in</span><span class="post-title">%title</span>', 'Parent post link', 'vw-car-rental' ),
                ) );
            } elseif ( is_singular( 'post' ) ) {
                // Previous/next post navigation.
                the_post_navigation( array(
                    'next_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Next', 'vw-car-rental' ) . '</span> ' .
                        '<span class="screen-reader-text">' . __( 'Next post:', 'vw-car-rental' ) . '</span> ' .
                        '<span class="post-title">%title</span>',
                    'prev_text' => '<span class="meta-nav" aria-hidden="true">' . __( 'Previous', 'vw-car-rental' ) . '</span> ' .
                        '<span class="screen-reader-text">' . __( 'Previous post:', 'vw-car-rental' ) . '</span> ' .
                        '<span class="post-title">%title</span>',
                ) );
            }
        ?>
