...
<html <?php language_attributes(); ?>>
	...
	<head>
	  ...
	  <link rel="profile" href="<?php echo esc_url( __( 'http://gmpg.org/xfn/11', 'vw-car-rental' ) ); ?>">
	  <?php wp_head(); ?>
	</head>
	...
	<?php wp_body_open(); ?>
		...
		<header role="banner">
    		<a class="screen-reader-text skip-link" href="#maincontent"><?php esc_html_e( 'Skip to content', 'vw-car-rental' ); ?></a>
			<div class="home-page-header">
				<?php get_template_part('template-parts/header/middle-header'); ?>
			</div>
		</header>

		<?php if(get_theme_mod('vw_car_rental_loader_enable',true)==1){ ?>
		  	<div id="preloader">
			    <div id="status">
			      <?php $theme_lay = get_theme_mod( 'vw_car_rental_loader_icon','Two Way');
